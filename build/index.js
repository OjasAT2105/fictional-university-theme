...
//     } else {
//       this.makeNoteEditabe(thisNote);
//     }
//   }
//   makeNoteEditabe(thisNote) {
//     thisNote
//       .find(".edit-note")
//       .html('<i class="fa fa-times" aria-hidden="true"></i>Cancle');
//     thisNote
...
/* Above code is written by jquery
------------------------------------------------------------------------------------
Below code is written by vanial javascript */
...
// class Search {
//   // 1. Describe the and create/initiate our object.
//   constructor() {
//     this.addSearchHTML(); // method to add the HTML
...
//     // keyup only fires once
//     // keydown fires multiple times if you hold the key down
//     this.searchField.on("keyup", this.typingLogic.bind(this));
//   }

//   // 3. methods (function, action, or whatever you want to call them)
...
//     setTimeout(() => this.searchField[0].focus({ preventScroll: false }), 301);
...
//                       .map(
//                         (item) =>
//                           `<li><a href="${item.permalink}" target="_blank">${item.title}</a></li>`
//                       )
//                       .join("")}
...
// ABOVE CODE IS USING JQUERY
// BELOW CODE IS USING VANILLA JS
